  ...
  async getAllPosts(options = {}) {
    ...
    return posts.map((post) => {
      ...
      if (postWithStatus.poll && postWithStatus.poll.votes && postWithStatus.poll.votes.length > 0) {
        console.log('🗳️ Poll vote found:', { postId: post.id, pollId: postWithStatus.poll.id, userId, votes: postWithStatus.poll.votes });
        ...
        console.log('❌ No poll vote found:', { postId: post.id, pollId: postWithStatus.poll.id, userId, votes: postWithStatus.poll.votes });
